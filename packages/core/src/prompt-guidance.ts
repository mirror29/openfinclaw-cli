...
export const OPENFINCLAW_AGENT_GUIDANCE = [
  ...
  "当用户需要对已有策略包做本地开发（发布、验证、Fork、排行榜、详情、本地列表、发布校验）时，使用 strategy 组的 strategy_* tool（strategy_publish, strategy_publish_verify, strategy_validate, strategy_fork, strategy_leaderboard, strategy_get_info, strategy_list_local），这是 DeepAgent 之外的本地 FEP v2.0 工作流。",
